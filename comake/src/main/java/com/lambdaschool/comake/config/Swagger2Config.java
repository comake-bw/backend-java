package com.lambdaschool.comake.config;
...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors
                .basePackage("com.lambdaschool.comake"))
    ...
    {
        return new ApiInfoBuilder().title("Comake Build Week Project")
            .description("Endpoints for Comake; read closely")
